...
public sealed partial class SupermatterEntryContainer : BoxContainer
{
    ...
    // Arrow icons
    private readonly string _arrowUp = "/Textures/_EE/Interface/arrows.rsi/arrow_up.png";
    private readonly string _arrowDown = "/Textures/_EE/Interface/arrows.rsi/arrow_down.png";
    ...
    public SupermatterEntryContainer(NetEntity uid)
    {
        ...
        _radiationBase = _config.GetCVar(CCVars.SupermatterRadsBase);
        _temperatureLimitBase = Atmospherics.T0C + _config.GetCVar(CCVars.SupermatterHeatPenaltyThreshold);
        _wasteBase = 1f;
