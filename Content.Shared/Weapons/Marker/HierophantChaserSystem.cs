...
/// </summary>
public sealed class HierophantChaserSharedSystem : EntitySystem
{
    ...
    public override void Update(float frameTime)
    {
        ...
        var eqe = EntityQueryEnumerator<HierophantChaserSharedComponent>();
    ...
    /// </summary>
    private void Cycle(Entity<HierophantChaserSharedComponent, TransformComponent?> ent)
    {
        ...
        if (ent.Comp1.Target != null && !TerminatingOrDeleted(ent.Comp1.Target))
        {
            ...
            else if (tileTargetPos.X != tilePos.X)
            {
                tileTargetPos.Y = tilePos.Y;
            }
            else
            {
